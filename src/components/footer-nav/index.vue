	...
	<div class="footer-nav-wraper">
		...
		<div v-if="navName === 'personal'" class="box">
			<router-link tag="a" :to="{name: 'GlobalCouponIndex'}" class="nav-tag">
				<img src="./images/discountsgrey.png" width="30" height="26" alt="外包项目" class="tag-ico" />
				<div class="tag-name">外包项目</div>
			</router-link>
		...
		<div v-if="navName !== 'personal'" class="box">
			<router-link tag="a" :to="{name: 'GlobalCouponIndex'}" class="nav-tag this-tag">
				<img src="./images/discountsblue.png" width="30" height="26" alt="外包项目" class="tag-ico" />
				<div class="tag-name">外包项目</div>
			</router-link>
