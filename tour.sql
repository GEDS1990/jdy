...
--
-- Table structure for table `tour_site`
--

DROP TABLE IF EXISTS `tour_site`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tour_site` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `site_name` varchar(50) NOT NULL DEFAULT '其他国家',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tour_site`
--

LOCK TABLES `tour_site` WRITE;
/*!40000 ALTER TABLE `tour_site` DISABLE KEYS */;
INSERT INTO `tour_site` VALUES (1,'不限'),(2,'北京'),(3,'上海'),(4,'深圳'),(5,'广州'),(6,'其它');
/*!40000 ALTER TABLE `tour_site` ENABLE KEYS */;
UNLOCK TABLES;
